...
namespace std
{
    ...
    public:
        ...
        explicit queue(const Alloc &a) : libcpp_queue<T, Container>(a) { _ctor_count++; };
        template <class Alloc>
        queue(const Container &c, const Alloc &a) : libcpp_queue<T, Container>(c, a) { _ctor_count++; };
        template <class Alloc>
        queue(Container &&c, const Alloc &a) : libcpp_queue<T, Container>(c, a) { _ctor_count++; };
        template <class Alloc>
        queue(const queue &c, const Alloc &a) : libcpp_queue<T, Container>(c, a) { _ctor_count++; };
        template <class Alloc>
        queue(queue &&c, const Alloc &a) : libcpp_queue<T, Container>(c, a) { _ctor_count++; };
